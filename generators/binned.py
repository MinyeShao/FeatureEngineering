...
from features.types import R_INT, R_FLOAT, S_BINNED

from features.generators.abstract import AbstractFeatureGenerator
from features import binning
from features.utils import get_smallest_valid_dtype_int

logger = logging.getLogger(__name__)


class BinnedFeatureGenerator(AbstractFeatureGenerator):
    """BinnedFeatureGenerator 将传入的 int 和 float 特征进行分箱 回num_bins个唯一的 int 值，排名和分箱的位置顺序相关."""
